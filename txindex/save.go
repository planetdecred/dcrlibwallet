...
// SaveLastIndexPoint this saves the last index
// of of block height height achieved.
...
// ClearSavedTransactions deletes a bucket
// saved on the transaction database.

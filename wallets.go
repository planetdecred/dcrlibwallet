...
//WalletsIterator returns all the available wallets and their index in a MultiWallet instance
...
//Next iterates over the the wallets in a MultiWallet instance and returns a wallet
// that has an index within the length of the available wallets

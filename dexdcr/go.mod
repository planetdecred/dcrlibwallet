...
require (
	...
	github.com/decred/dcrd/blockchain/standalone/v2 v2.0.1-0.20210914212651-723d86274b0d // indirect
...
replace (
	// decred.org/dcrdex => ../../../decred/dcrdex
	decred.org/dcrdex => github.com/itswisdomagain/dcrdex v0.0.0-20211003142309-77f324791a85
